...
class person(models.Model):
    name = models.CharField(max_length=128, verbose_name='姓名', help_text='员工的名字', null=False, blank=False,
                            db_index=True)
    useid = models.IntegerField(max_length=256, verbose_name='工号', null=True, unique=True)
    gender_choices = (
        (0, '未知'),
        (1, '男'),
        (2, '女'),
    ...
    beizhu = models.TextField(verbose_name='备注', help_text='可填写过往工作经历及岗位', null=True, blank=True)
